...
final class MonetizationManager: NSObject, ObservableObject {
    ...
    // Deprecated: Use canGenerateHockeyCard() instead
    func hasUsedFreeHockeyCard() -> Bool {
        return UserDefaults.standard.bool(forKey: "hasUsedFreeHockeyCard")
    }

    // Deprecated: Use incrementHockeyCardGenerationCount() instead
